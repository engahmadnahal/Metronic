        ...
        <div class="card card-custom gutter-b example example-compact">
            ...
            <form id="create-form">
                <div class="card-body">
                        ...
                        <x-input id="ratio" type="number" name="{{ __('cms.ratio') }}" />
                        <x-input id="all_beneficiaries" type="number" name="{{ __('cms.all_beneficiaries') }}" />
                        {{-- <x-input id="current_beneficiaries" type="number" name="{{ __('cms.current_beneficiaries') }}"/> --}}
