    ...
    <div class="card-header border-0 py-5">
        ...
        <div class="card-toolbar">
            <a href="{{route('payments.create')}}"
                class="btn btn-info font-weight-bolder font-size-sm">{{__('cms.new_payment')}}</a>
        </div>
        @endcan
    </div>
    <!--end::Header-->
            ...
            <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_2">
                ...
                <tbody>
                    ...
                    <tr>
                        {{-- <td class="pl-0">
                            <a href="#"
                                class="text-dark-75 font-weight-bolder text-hover-primary font-size-lg">{{$payment->id}}</a>
                        </td> --}}
                        <td class="pl-0">
                            <a href="#"
                                class="text-dark-75 font-weight-bolder text-hover-primary font-size-lg">{{$payment->name
                                ?? ''}}</a>
                        </td>
                        ...
                        <td>
                            <span
                                class="label label-lg @if($payment->active) label-light-success @else label-light-warning @endif label-inline">{{$payment->active_key}}</span>
                        </td>
                        <td class="pr-0 text-right">
                            ...
                            @endcan
                            @can('Delete-Payment')
                            <a href="#" onclick="performcityDestroy('{{$payment->id}}', this)"
