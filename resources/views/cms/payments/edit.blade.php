    ...
    <div class="col-lg-12">
       {{-- {{dd(isset($data['country']));}} --}}
        ...
        <div class="card card-custom gutter-b example example-compact">
            ...
            <form id="create-form">
                <div class="card-body">
                    <x-input id="name" type="text" name="{{ __('cms.name') }}" value="{{$payment->name}}"/>
                    
                    <div class="form-group col-3">
                        <label class="col-3 col-form-label">{{ __('cms.image') }}:</label>
                        <div class="col-9">
                            <div class="image-input image-input-empty image-input-outline" id="kt_image_5"
                                style="background-image: url({{Storage::url($payment->logo)}})">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-3">
                            <span class="switch switch-outline switch-icon switch-success">
                                <label>
                                    <input type="checkbox" @checked($payment->active) id="active">
                                    <span></span>
                                </label>
                            </span>
                        </div>
...
<script>
    function performUpdate(){
        ...
        store('/cms/admin/payments/{{$payment->id}}',formData);
    }
</script>
@endsection