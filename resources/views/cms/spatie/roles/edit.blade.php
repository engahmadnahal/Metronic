                        ...
                        <div class="col-lg-4 col-md-9 col-sm-12">
                            <div class="dropdown bootstrap-select form-control dropup">
                                <select class="form-control selectpicker" data-size="7" id="guard_name"
                                    ...
                                    <option value="specialist" @if($role->guard_name == 'specialist') selected
                                        @endif>Specialist</option>
                                    <option value="user-api" @if($role->guard_name == 'user-api') selected @endif>User
                                        App
                                    </option>
                                    <option value="specialist-api" @if($role->guard_name == 'specialist-api') selected
                                        @endif>Specialist App</option>
                                </select>
                            </div>
