...
<div class="card card-custom gutter-b">
    ...
    <div class="card-header border-0 py-5">
        ...
        <div class="card-toolbar">
            ...
            <a href="{{route('products.importExcel')}}"
                class="btn btn-info font-weight-bolder font-size-sm mr-2">{{__('cms.import_excel')}}</a>

            <a href="{{route('products.zip')}}"
                class="btn btn-info font-weight-bolder font-size-sm mr-2">{{__('cms.upload_zip_file')}}</a>

            <a href="{{route('pdf.product')}}" target="_blanck"
                    ...
                    <tr>
                        <td class="pl-0">
                            <a href="{{route('products.show',$product->id)}}"
                                class="text-dark-75 font-weight-bolder text-hover-primary font-size-lg">{{$product->translations->first()?->name
                                ?? ''}}</a>
                        </td>
                        <td>
                            <span href="#" class="label label-lg label-light-success label-inline">{{$product->code
                                ?? ''}}</span>
                        </td>
                        <td>
                            <span
                                class="label label-lg label-light-info label-inline">{{$product->subSubCategory->subCategory->category->name
                                ??'-'}}
                            </span>
                        </td>
                        <td>
                            <span class="label label-lg label-light-info label-inline">{{$product->subSubCategory->name
                                ??'-'}}</span>
                        </td>
                        <td>
                            <a href="#" data-toggle="modal" data-target="#product_{{$product->id}}_translations"
                                class="btn btn-light-primary font-weight-bolder font-size-sm">({{$product->translations_count}})</a>
                            <div class="modal fade" id="product_{{$product->id}}_translations" tabindex="-1"
                                role="dialog" aria-labelledby="product_{{$product->id}}_translations"
                                aria-hidden="true">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="pr-0 text-right">
                                                            @can('Update-Region')
                                                            <a href="{{route('product-translations.edit',$translation->id)}}"
                        ...
                        <td class="pr-0 text-right">
                            @can('Create-Product')
                            <a href="{{route('product-translations.create',$product->id)}}"
                                class="btn btn-icon btn-light btn-hover-primary btn-sm">
