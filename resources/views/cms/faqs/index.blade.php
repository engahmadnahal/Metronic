            ...
            <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_2">
                <thead>
                    <tr class="text-uppercase">
                        ...
                        <th class="pl-0" style="min-width: 100px">{{__('cms.question')}}</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="pl-0">
                            <a href="#"
                                class="text-dark-75 font-weight-bolder text-hover-primary font-size-lg">{{$faq->translations->first()?->question
                                ?? ''}}</a>
                        </td>
                        <td class="pl-0">
                            <a href="#"
                                class="text-dark-75 font-weight-bolder text-hover-primary font-size-lg">{{$faq->answer
                                ?? ''}}</a>
                        </td>
                        <td>
                            <a href="#" data-toggle="modal" data-target="#faq_{{$faq->id}}_translations"
                                class="btn btn-light-primary font-weight-bolder font-size-sm">({{$faq->translations_count}})</a>
                            <div class="modal fade" id="faq_{{$faq->id}}_translations" tabindex="-1" role="dialog"
                                aria-labelledby="faq_{{$faq->id}}_translations" aria-hidden="true">
                        ...
                        <td>
                            <span
                                class="label label-lg @if($faq->active) label-light-success @else label-light-warning @endif label-inline">{{$faq->active_key}}</span>
                        </td>
                        <td class="pr-0 text-right">
                            @can('Create-Country')
                            ...
                            @endcan
                            @can('Delete-Country')
                            <a href="#" onclick="performCountryDestroy('{{$faq->id}}', this)"
                                class="btn btn-icon btn-light btn-hover-primary btn-sm">
                                <span class="svg-icon svg-icon-md svg-icon-primary">
                                    <!--begin::Svg Icon | path:assets/media/svg/icons/General/Trash.svg-->
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
...
<script>
    function performCountryDestroy(id,reference) {
        confirmDestroy('/cms/admin/faqs', id, reference);
    }
    function performTranslationDestroy(id,reference) {
        confirmDestroy('/cms/admin/faqs/translations', id, reference);
    }
</script>
@endsection