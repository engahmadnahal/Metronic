            ...
            <form id="create-form">
                ...
                <div class="card-footer">
                    <div class="row">
                        ...
                        <div class="col-9">
                            <button type="button" onclick="performStore({{$tradeMark->id ?? null}})"
...
<script>
    ...
    function getCountries(languageId) {
        blockUI();
        axios.get(`/cms/admin/tradeCompaies/translation/${languageId}`)
        .then(function (response) {
            if(response.data.companies.length != 0) {
                response.data.companies.map((company) => {
                    $('#company').append(new Option(company.name, company.company_trade_mark_id))
...
<script>
    function performStore(id){
        ...
        if(id == null) {
            ...
            store('/cms/admin/tradmarks',data);
        }else {
            store('/cms/admin/tradmarks/'+id+'/translation',data);
        }
    }
</script>
@endsection