            ...
            <form id="create-form">
                <div class="card-body">
                    ...
                    <div class="form-group row mt-4">
                        ...
                        <div class="col-lg-4 col-md-9 col-sm-12">
                            <input type="text" class="form-control" id="title" placeholder="{{__('cms.name')}}" />
                ...
                <div class="card-footer">
                    <div class="row">
                        ...
                        <div class="col-9">
                            <button type="button" onclick="performStore({{$storeCategory->id ?? null}})"
...
<script>
    function performStore(id){
        ...
        if(id == null) {
            store('/cms/admin/store-category',data);
        }else {
            store('/cms/admin/store-category/'+id+'/translation',data);
        }
    }
</script>
@endsection