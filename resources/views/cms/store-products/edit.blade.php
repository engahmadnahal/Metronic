            ...
            <form id="create-form">
                        ...
                        <div class="col-lg-4 col-md-9 col-sm-12">
                            <div class="dropdown bootstrap-select form-control dropup">
                                <select class="form-control selectpicker" data-size="7" id="product_id"
                                    ...
                                    @foreach ($products as $productStore)
                                    <option value="{{$productStore->id}}" @selected( $productStore->id==
                                        $product->product_id)>{{$productStore->translations->first()->name}}
                                    </option>
                                    @endforeach
                                </select>
                            </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-3">
                            <span class="switch switch-outline switch-icon switch-success">
                                <label>
                                    <input type="checkbox" checked="checked" @checked($product->active) id="active">
                                    <span></span>
                                </label>
                            </span>
                        </div>
                ...
                <div class="card-footer">
                    <div class="row">
                        ...
                        <div class="col-9">
                            <button type="button" onclick="performStore('{{$product->id}}')"
...
<script>
    function performStore(id){
        ...
        update('/cms/admin/store-products/'+id, data, '/cms/admin/store-products');
    }
</script>
@endsection