            ...
            <table class="table table-head-custom table-vertical-center" id="kt_advance_table_widget_2">
                <thead>
                    <tr class="text-uppercase">
                        ...
                        @canany(['Update-Store-Product','Delete-Store-Product'])
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="pl-0">
                            <a href="#"
                                class="text-dark-75 font-weight-bolder text-hover-primary font-size-lg">{{$product->product->translations->first()?->name
                                ?? ''}}</a>
                        </td>
                        <td>
                            <a href="#"
                                class="label label-lg label-light-success label-inline">{{$product->product->barcode
                                ?? ''}}</a>
                        </td>
                        <td class="pl-0">
                            <a href="#"
                                class="text-dark-75 font-weight-bolder text-hover-primary font-size-lg">{{$product->price
                                ?? ''}}</a>
                        </td>
                        <td class="pl-0">
                            <a href="#"
                                class="text-dark-75 font-weight-bolder text-hover-primary font-size-lg">{{$product->item_count ?? '0'
                                ?? ''}}</a>
                        </td>
                        <td>
                            <span
                                class="label label-lg label-light-info label-inline">{{$product->product->subSubCategory->subCategory->category->name
                                ??'-'}}
                            </span>
                        </td>
                        <td>
                            <span
                                class="label label-lg label-light-info label-inline">{{$product->product->subSubCategory->name
                                ??'-'}}</span>
                        </td>
                        <td>
                            <span class="label label-lg label-light-info label-inline">{{$product->view
                                ??'-'}}</span>
                        </td>
                        <td>
                            <a href="#" class="label label-lg label-light-success label-inline">{{$product->overal_rate
                                ?? ''}}</a>
                        </td>
                        <td>
                            <span
...
<script>
    function performcityDestroy(id,reference) {
        confirmDestroy('/cms/admin/store-products', id, reference);
    }
</script>
@endsection